...
DROP USER fredericopitol
;
-- Excluindo database uvv caso ela exista
DROP DATABASE uvv;
-- Criando usuário
CREATE USER fredericopitol IDENTIFIED BY 'frederico';
-- Garantindo privilégios para o usuário fredericopitol
...
ALTER TABLE localizacoes MODIFY COLUMN cep VARCHAR(12) COMMENT 'Codigo postal da localizacao';

ALTER TABLE localizacoes MODIFY COLUMN cidade VARCHAR(50) COMMENT 'Cidade onde está localizado o departamento.';

ALTER TABLE localizacoes MODIFY COLUMN uf VARCHAR(25) COMMENT 'Estado(abreviado ou por extenso)';
...
ALTER TABLE cargos COMMENT 'Armazena os cargos existentes e a faixa salarial (mínimo e máximo)';
...
CREATE TABLE empregados (
                ...
                id_supervisor INT,
                id_departamento_funcionario INTEGER,
                PRIMARY KEY (pk_id_empregado)
);

ALTER TABLE empregados COMMENT 'Informações dos empregados';

ALTER TABLE empregados MODIFY COLUMN pk_id_empregado INTEGER COMMENT 'Chave primária da tabela';
...
ALTER TABLE empregados MODIFY COLUMN telefone VARCHAR(20) COMMENT 'Telefone do empregado Ex: 5522999999999';

ALTER TABLE empregados MODIFY COLUMN data_contratacao DATE COMMENT 'Data que o empregado iniciou no cargo atual.';

ALTER TABLE empregados MODIFY COLUMN id_cargo VARCHAR(10) COMMENT 'Indica o cargo atual do empregado';

ALTER TABLE empregados MODIFY COLUMN salario DECIMAL(8, 2) COMMENT 'Salário mensal atual do empregado.';

ALTER TABLE empregados MODIFY COLUMN comissao DECIMAL(4, 2) COMMENT 'Comissão do dep de vendas.';

ALTER TABLE empregados MODIFY COLUMN id_supervisor INTEGER COMMENT 'Indica o supervisor direto do empregado';
...
ALTER TABLE departamentos COMMENT 'Informações sobre os departamentos da empresa';
...
ALTER TABLE departamentos MODIFY COLUMN fk_id_localizacao INTEGER COMMENT 'Chave estrangeira para a tabela de localizações';

ALTER TABLE departamentos MODIFY COLUMN id_gerente INTEGER COMMENT 'FK da tabela empregados';
...
CREATE TABLE historico_cargos (
                pfk_id_empregado INT NOT NULL,
                data_inicial DATE NOT NULL,
                data_final DATE NOT NULL,
                id_cargo VARCHAR(10) NOT NULL,
                id_departamento INT NOT NULL,
                PRIMARY KEY (data_inicial, pfk_id_empregado)
);

ALTER TABLE historico_cargos COMMENT 'Tabela que armazena o histórico de cargos de um empregado.';

ALTER TABLE historico_cargos MODIFY COLUMN data_inicial DATE COMMENT 'Indica a data inicial do empregado em um cargo';

ALTER TABLE historico_cargos MODIFY COLUMN pfk_id_empregado INTEGER COMMENT 'Chave primária da tabela';
...
ALTER TABLE historico_cargos MODIFY COLUMN id_departamento INTEGER COMMENT 'Identificador do departamento';
...
-- Populando dados da tabela paises
...
-- Populando dados da tabela localizações
...
-- Desabilitando restrição de chave estrangeira para inserção de dados 
...
-- Populando tabela historico_cargos
